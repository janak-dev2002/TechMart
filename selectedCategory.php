...
if (isset($_GET["ur"]) || isset($_GET["mid"]) || $_GET["subid"] || $_GET["mainbid"]) {

    $urlName = $_GET["ur"];
    $Mid = isset($_GET["mid"]) ? $_GET["mid"] : null;
    $subCategoryId = isset($_GET["subid"]) ? $_GET["subid"] : null;
    $categoryId = isset($_GET["mainbid"]) ? $_GET["mainbid"] : null;
...
?>
    ...
    <head>
        ...
        <title>Tech Mart | Product Listning</title>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row d-flex flex-column">
                                        ...
                                        <div class="col-12 mb-5">
                                            <select class="form-select text-center border border-start-0 border-top-0 border-end-0 border-2 border-primary shadow-none" id="s">
                                                ...
                                                <?php
                                                $brand_rs = Database::search("SELECT DISTINCT `name` FROM `brand` ");
                                                ...
                                                ?>
                                                    ...
                                                    <option value="<?php echo $z; ?>"><?php echo $barnd_data["name"]; ?></option>
                        ...
                        <div class="offset-lg-1 col-lg-7 col-md-12 offset-1 col-10">
                            <div class="row ">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center justify-content-md-start" style="column-gap: 90px;" id="basic_search_result">
                                        ...
                                        ?>
                                                ...
                                                <div class="col-3 mt-4 mb-4 card  border-0 shadow" style="width: 19rem;">
                                                    ...
                                                    <div class="card-body text-center mt-3">
                                                        ...
                                                        <h2 class="price">Rs. <?php echo number_format($selected_data["price"], 2); ?></h2>
                                ...
                                `user_email` = '" . $_SESSION["u"]["email"] . "'");
                                            ...
                                            $product_rs = Database::search("SELECT * FROM `product` WHERE `mini_category_id` = '" . $Mid . "'");
                                            $product_num = $product_rs->num_rows;
                                            ...
                                            $subCategoryId = isset($subCategoryId) ? $subCategoryId : null;
                                            $categoryId = isset($categoryId) ? $categoryId : null;

                                            $whereClause = "";

                                            if (!empty($Mid)) {
                                                $whereClause = "mini_category.id = '" . $Mid . "'";
                                            } elseif (!empty($subCategoryId)) {
                                                $whereClause = "sub_category.id = '" . $subCategoryId . "'";
...
FROM 
    product 
INNER JOIN 
    mini_category ON product.mini_category_id = mini_category.id 
INNER JOIN 
    sub_category ON mini_category.Sub_category_id = sub_category.id 
INNER JOIN 
...
OFFSET 
    " . $page_results;
                                            ...
                                            for ($x = 0; $x < $selected_num; $x++) {
                                                ...
                                                // Access the product id using the alias
