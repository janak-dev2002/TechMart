...
?>
                ...
                <div class="col-3 mt-4 mb-4 card  border-0 shadow" style="width: 19rem;">
                    ...
                    <img onclick="showitem(<?php echo "productView.php?id=" . $product_data['id'] ?>);" class="mt-3 im2" src="<?php echo $image_data["code"]; ?>">
                    <div class="card-body text-center mt-3">
                        ...
                        <h2 class="price">Rs. <?php echo number_format($product_data["price"], 2); ?>.00</h2>
