                ...
                <div class="col-12" id="page">
                    <div class="row">
                        ...
                        if ($invoice_num == 1) {
                            ...
                            $invoice_item_rs = Database::search("SELECT * FROM `invoice_items` WHERE `invoice_id` = '" . $invoice_data["id"] . "'");
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-6 text-center">
                                                                <h6>Rs.<?php echo number_format($product_data["price"],2); ?></h6>
                                                            </div>
                                                            <div class="col-6 text-center">
                                                                <h6><?php echo $invoice_item_data["qty"]; ?></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6 text-center">
                                                <h6>Rs.<?php echo number_format($product_data["price"] * $invoice_item_data["qty"],2); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-6">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row">
                                                                <div class="col-6 text-center">
                                                                    <h6>Rs.<?php echo number_format($product_data1["price"], 2); ?></h6>
                                                                </div>
                                                                <div class="col-6 text-center">
                                                ...
                                                <div class="col-6 text-center">
                                                    <h6>Rs.<?php echo number_format($product_data1["price"] * $invoice_data_1["qty"], 2); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6 offset-6">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <h6 class="text-black">Rs.<?php echo number_format($product_data["price"] * $invoice_item_data["qty"], 2); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="row">
                                            <div class="col-6">
                                                <h6 class="text-black">Shipping</h6>
                                            </div>
                                            <div class="col-6">
                                                <h6 class="text-black">Rs <?php echo number_format($invoice_data["delivary"], 2); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <h6 class="text-black">Rs 0.00</h6>
                                            </div>
                                            <div class="col-12">
                                                <hr>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <h6 class="text-black fw-bold">Rs <?php echo number_format($invoice_data["total"], 2); ?></h6>
                                            </div>
                                            <div class="col-12">
