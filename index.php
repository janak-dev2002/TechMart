            ...
            <div class="col-12">
                <div class="row py-3">
                    <div class="col-md-6 col-12 mb-4 mb-md-0">
                        <a onclick="selectCategory('msi gaming',17);" class="cursorrr">
                    ...
                    <div class="col-md-6 col-12">
                        <a  onclick="selectCategory('q',4);" class="cursorrr">
                ...
                <div class="row p-3">
                    <div class=" col-12 col-md-6 mb-md-5 d-flex flex-column justify-content-center py-4" style="background-color: #74AFBE;">
                        <div class="offset-md-2 row">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <a onclick="selectCategory('gaming headset',112);" class="fw-bold cursorrr btn btn-outline-dark shop2-btn " style="font-size: 30px;" type="submit">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
