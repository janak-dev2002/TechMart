...
?>
    ...
    <div class="col-12 mt-2">
        ...
        <div class="btn-group dropend col-12 d-flex justify-content-between">
            ...
            <h6 onclick="selectMainCategory('<?php echo $mainCategory_data['name']; ?>',<?php echo $mainCategory_data['id']; ?>);" type="button" class="text-uppercase"><img src="<?php echo $mainCategory_data["icon_path"] ?>"> &nbsp;<?php echo $mainCategory_data["name"]; ?></h6>
                            ...
                            ?>
                                ...
                                <div class="col-4">
                                    <div class="subcat-title">
                                        ...
                                        <h6 onclick="selectSubCategory('<?php echo $subCategory_data['sub_name']; ?>',<?php echo $subCategory_data['id']; ?>);" class=" text-uppercase"><a href="#" class="subcat-titl text-decoration-none p-2 text-black fw-bold"><?php echo $subCategory_data["sub_name"]; ?></a></h6>
