...
<head>
    ...
    <title>TechMart| Cart Purchase</title>
        ...
        <div class="container py-5">
            <div class="row">
                    ...
                    <div class="row clr-bg d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-2">
                                ...
                                <li class="breadcrumb-item active text-black-50" aria-current="page">Buy now this cart</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex flex-column">
                            <div class="row">
                                ...
                                $Cartproduct_rs = Database::search("SELECT * FROM `cart` WHERE `user_email` = '" . $email . "'");
                                            ...
                                            <div class="col-12 mt-3">
                                                <div class="row d-flex justify-content-between">
                                                    <div class="col-2  text-center text-md-start">
                                                        <h6 class="text-black-50" style="font-size: 13px;"> QTY : <?php echo $Cartproduct_data["qty"]; ?></h6>
                                                    </div>
                                                    <div class="col-4 text-end">
                                                        <h6 class="text-black" style="font-size: 13px;">PRICE : Rs. <?php echo ($product_data["price"]) * $cart_data["qty"]; ?>.00</h6>
                                                    </div>
                ...
                <div class="ms-md-3 col-md-3 col-12 mt-5 shadow" style="height: 650px;">
                    ...
                    <div class="row d-flex flex-column " id="pricing_details">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row d-flex align-items-center">
                                <div class="col-7">
                                    <h6 class="text-black-50" style="font-size: 15px;">Items Total (<?php $cartQty_rs = Database::search("SELECT SUM(`qty`) AS `totalCart` FROM `cart` WHERE `user_email` = '" . $email . "'");
                                                                                                    $cartQty_data = $cartQty_rs->fetch_assoc();
                                                                                                    echo $cartQty_data["totalCart"]; ?> items)</h6>
                                </div>
                        ...
                        <div class="col-9 mt-3 d-grid">
                            <button onclick="payNow(<?php echo $product_data['id']; ?>,<?php echo $cartQty_data['totalCart']; ?>,1,<?php echo $shipping; ?>);" class="btn btn-outline-dark btn-dark btnclr text-center text-decoration-none" style="font-size: 16px;">PROCEED TO CHECKOUT</button>
                        </div>
                ...
                <div class="modal" tabindex="-1" id="payPanel">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Easy to pay</h5>
