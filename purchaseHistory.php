                    ...
                    <div class="col-12 d-none d-md-block">
                        <div class="row">
                            ...
                            for ($x = 0; $x < $invoice_num; $x++) {
                                ...
                                $invoice_items_rs = Database::search("SELECT * FROM `invoice_items` WHERE `invoice_id` = '" . $invoice_data["id"] . "'");
                                $invoice_items_num = $invoice_items_rs->num_rows;

                                for ($y = 0; $y < $invoice_items_num; $y++) {

                                    $invoice_items_data = $invoice_items_rs->fetch_assoc();

                                    $product_rs = Database::search("SELECT * FROM `product` WHERE `id` = '" . $invoice_items_data["product_id"] . "'");
                                    $product_data = $product_rs->fetch_assoc();

                                    $product_img_rs = Database::search("SELECT * FROM `images` WHERE `product_id` = '" . $invoice_items_data["product_id"] . "'");
                                ...
                                <div class="col-12">
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-1 border-end d-flex flex-column justify-content-center">
                                            <div class="col-12">
                                                <div class="row text-center">
                                                    <h6><?php echo $invoice_items_data["qty"]; ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="offset-1 col-10">
                                                <div class="row text-center">
                                                    <div class="col-12 text-center mb-3">
                                                        <div class="row">
                                                            <button class="btn btn-outline-dark btn-dark btnclr text-center text-decoration-none" style="font-size: 16px;" onclick="addFeedback(<?php echo $invoice_items_data['product_id']; ?>);"><i class="bi bi-info-circle"></i> feedback</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 text-center">
                                                        <div class="row">
                    ...
                    <div class="col-12 d-block d-md-none">
                        <div class="row">
                            ...
                            for ($y = 0; $y < $invoice_num1; $y++) {
                                ...
                                $invoice_items_rs1 = Database::search("SELECT * FROM `invoice_items` WHERE `invoice_id` = '" . $invoice_data1["id"] . "'");
                                $invoice_items_num1 = $invoice_items_rs1->num_rows;

                                for ($z = 0; $z < $invoice_items_num1; $z++) {

                                    $invoice_items_data1 = $invoice_items_rs1->fetch_assoc();

                                    $product_rs1 = Database::search("SELECT * FROM `product` WHERE `id` = '" . $invoice_items_data1["product_id"] . "'");
                                    $product_data1 = $product_rs1->fetch_assoc();

                                    $product_img_rs1 = Database::search("SELECT * FROM `images` WHERE `product_id` = '" . $invoice_items_data1["product_id"] . "'");
                                    ...
                                    $brandhasmodel_rs1 = Database::search("SELECT * FROM `brand_has_model` WHERE `id` = '" . $product_data1["brand_has_model_id"] . "'");
                                    $brandhasmodel_data1 = $brandhasmodel_rs1->fetch_assoc();

                                    $brand_rs1 = Database::search("SELECT * FROM `brand` WHERE `id` = '" . $brandhasmodel_data1["brand_id"] . "'");
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="row d-flex p-1">
                                                ...
                                                <div class="col-4">
                                                    <div class="row d-flex flex-column">
                                                        <div class="col-12">
                                                            <h6 style="font-size: 14px;" class="text-black-50">Qty : <span><?php echo $invoice_items_data1["qty"]; ?> items</span></h6>
                                                        </div>

                                                        <div class="col-12">
                                                            <h6 style="font-size: 14px;" class="text-black-50">Total : <span>Rs.<?php echo number_format($invoice_data1["total"],2); ?></span></h6>
                                                        </div>
                                                        ...
                                                        <div class="col-12 mt-1 d-grid ">
                                                            <button onclick="reomovePurchaseHistory('<?php echo $invoice_items_data1['id']; ?>');" class="btn btn-outline-dark btn-danger btnclrwatch text-center text-decoration-none" style="font-size: 13px;"><i class="bi bi-trash"></i> Remove</button>
                                                        </div>
