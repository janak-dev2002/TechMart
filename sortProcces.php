                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <span class="card-text fw-bold text-primary">Rs. <?php echo ($selected_data["price"]); ?></span><br />
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-bold text-info" for="fd<?php echo ($selected_data["id"]); ?>">
                                    Make your product <?php if ($selected_data["status_id"] == 2) {
                                                            echo "Deactivate";
                                                        } else {
                                                            echo "Activate";
                                                        } ?>
        ...
        <ul class="pagination pagination-lg justify-content-center">
            ...
            ?>
                    <li class="page-item active">
                        <a class="page-link" onclick="sort(<?php echo ($x); ?>);" <?php echo "?page=" . ($x); ?>><?php echo $x; ?></a>
                    </li>
                <?php
                } else {
