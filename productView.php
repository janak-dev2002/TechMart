            ...
            <div class="container py-1">
                <div class="row">
                    ...
                    <div class="col-12 mt-1 rounded-4 py-5">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col-md-6 col-12 mt-4 mt-md-0">
                                <div class="row d-flex flex-column  text-center text-md-start">
                                    <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            <div class="col-12">
                                                <span class="fs-3 fw-bold text-dark">Rs. <?php echo number_format($price, 2); ?></span>
                                            </div>
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-12">
                                            <h4 class="text-black fw-bold" style="font-size: 15px;">Availability &nbsp;&nbsp;&nbsp;&nbsp;: <span id="qty_available" class="clr-bg rounded-4 fw-lighter text-white">&nbsp;<?php echo $product_data["qty"]; ?> <span>Items In Stock</span> &nbsp;</span></h4>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-12">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 d-md-block d-flex justify-content-center">
                                            <a href="https://www.payhere.lk" target="_blank">
                                                <img src="https://www.payhere.lk/downloads/images/payhere_square_banner_dark.png" alt="PayHere" width="280" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6 col-12 d-grid d-md-block justify-content-center ">
                                            <div class="row flex-column">
                                                ...
                                                <div class="col-12 col-md-10 d-grid mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-1 d-flex d-md-block justify-content-center">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row d-flex justify-content-center justify-content-md-between " id="viewProducts">
